...
export default function Dashboard({ projects, onOpen, onNew, filter, setFilter, sortBy, setSortBy, query, setQuery, syncing, syncError, onLogout, userEmail, onProfile }) {
  const list = useMemo(() => {
  ...
  return (
    <div style={{ minHeight: "100vh" }}>
      <TopNav onNew={onNew} syncing={syncing} syncError={syncError} onLogout={onLogout} userEmail={userEmail} onProfile={onProfile} />
