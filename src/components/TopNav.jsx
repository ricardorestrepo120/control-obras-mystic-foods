...
export default function TopNav({ onNew, onBack, project, isNew, onSave, onDelete, onShare, canSave, syncing, syncError, onLogout, userEmail, onProfile }) {
  ...
  return (
    <div style={{ position: "sticky", top: 0, zIndex: 50, background: "color-mix(in oklch,var(--bg) 88%,transparent)", backdropFilter: "blur(12px)", borderBottom: "1px solid var(--bd)" }}>
      <div style={fx({ maxWidth: 1100, margin: "0 auto", height: 56, gap: 8, padding: "0 var(--pp)" })}>
        ...
        {onProfile && <Btn variant="ghost" size="sm" icon={<I.User size={14} />} onClick={onProfile} title="Mi perfil" />}
